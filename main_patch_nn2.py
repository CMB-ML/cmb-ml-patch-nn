...
def run_cmbnncs(cfg):
    ...
    # pipeline_context.add_pipe(TryShowPatchExecutor)  # Deacivate unless demo
    # pipeline_context.add_pipe(TryShowPatchDistExecutor)  # Deacivate unless demo
    ...
    # pipeline_context.add_pipe(PreprocessPatchesExecutor)  # Deacivate unless demo

    # These executors are useful for demonstration/debugging
    # pipeline_context.add_pipe(TrainingTryDataloaderExecutor)  # Deacivate unless demo
    # pipeline_context.add_pipe(TrainingTryNetworkExecutor)  # Deacivate unless demo
    ...
    # These executors are useful for demonstration/debugging
    # pipeline_context.add_pipe(PredictTryDataloaderExecutor)  # Deacivate unless demo
    # pipeline_context.add_pipe(PredictTryModelLoadExecutor)  # Deacivate unless demo
    ...
    # pipeline_context.add_pipe(PixelAnalysisExecutor)  # Deacivate unless demo
    # pipeline_context.add_pipe(PixelSummaryExecutor)  # Deacivate unless demo
    # pipeline_context.add_pipe(PixelSummaryFigsExecutor)  # Deacivate unless demo
    ...
    # pipeline_context.add_pipe(ConvertTheoryPowerSpectrumExecutor)  # Deacivate unless demo
    # pipeline_context.add_pipe(MakeTheoryPSStats)  # Deacivate unless demo

    # # # # # CMBNNCS's Predictions as Power Spectra Anaylsis
    # pipeline_context.add_pipe(NNMakePSExecutor)  # Deacivate unless demo
    # # # pipeline_context.add_pipe(ShowOnePSExecutor)  # Used for debugging; does not require full set of theory ps for simulations
    # pipeline_context.add_pipe(PSAnalysisExecutor)  # Deacivate unless demo
    # pipeline_context.add_pipe(PowerSpectrumSummaryExecutor)  # Deacivate unless demo
    # pipeline_context.add_pipe(PowerSpectrumSummaryFigsExecutor)  # Deacivate unless demo
    # pipeline_context.add_pipe(PostAnalysisPsFigExecutor)  # Deacivate unless demo
